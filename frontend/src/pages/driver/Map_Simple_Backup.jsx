            ...
            <div className="h-full bg-gradient-to-br from-blue-50 to-green-50 dark:from-blue-900 dark:to-green-900 flex items-center justify-center relative">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-lg border-2 border-blue-200 dark:border-blue-800">
                    <div className="text-2xl font-bold text-blue-600">12</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">👥 Học sinh</div>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-lg border-2 border-green-200 dark:border-green-800">
                    <div className="text-2xl font-bold text-green-600">5</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">📍 Trạm dừng</div>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-lg border-2 border-orange-200 dark:border-orange-800">
                    <div className="text-2xl font-bold text-orange-600">2.5</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">🛣️ km còn lại</div>
                  </div>
                </div>
                ...
                <div className="mt-6 max-w-lg mx-auto">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-600">
                    <h4 className="font-bold text-gray-800 dark:text-white mb-3 flex items-center">
                      🗺️ Tuyến đường hôm nay
                    </h4>
                    <div className="flex items-center space-x-2 text-sm">
                      <div className="flex items-center space-x-1">
                        <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                        <span className="text-green-600 font-medium">Xuất phát</span>
                      </div>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-red-600 font-medium">Đích đến</span>
                      </div>
                    </div>
                  </div>
                </div>
