                ...
                <div className="space-y-4">
                  {schedules.map((schedule) => (
                    <div
                      ...
                      className={`group p-5 rounded-xl border-2 cursor-pointer transition-all duration-300 transform hover:scale-[1.02] ${selectedSchedule?.schedule_id === schedule.schedule_id
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <div className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold shadow-md ${schedule.status === 'active'
                    ...
                    {students.map((student) => (
                      <div key={student.trip_id} className="group p-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-blue-400 dark:hover:border-blue-500 transition-all duration-300 bg-white/50 dark:bg-gray-700/30 hover:shadow-lg">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold shadow-md ${student.trip_status === 'waiting' ? 'bg-gradient-to-r from-yellow-500 to-orange-500 text-white' :
